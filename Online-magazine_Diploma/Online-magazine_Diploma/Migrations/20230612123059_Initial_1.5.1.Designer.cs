...
namespace Online_magazine_Diploma.Migrations
{
    ...
    [Migration("20230612123059_Initial_1.5.1")]
    partial class Initial_151
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Online_magazine_Diploma.DataAccess.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("39a41dd7-603a-41c4-b8d4-9981de8fa1f2"),
                            Email = "admin@mail.com",
                            IsDeleted = false,
                            Name = "admin",
                            PasswordHash = "APH9UuLd+1VkQkLuJ9lBIc6oASNkjrp+Mu6BjpKeK5z4LGMYKu8ZEGtGX+l2mmG1Rg==",
