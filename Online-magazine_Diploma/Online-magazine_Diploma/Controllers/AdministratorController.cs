...
namespace Online_magazine_Diploma.Controllers
{
    public class AdministratorController : Controller
    {
        ...
        [HttpGet(Name = "PersonalAccount")]
        public async Task<IActionResult> PersonalAccount()
        {
            return View();
        }

        [HttpGet(Name = "ManageUsers")]
        ...
        [HttpPost(Name = "EditUserRolePost")]
        ...
        [HttpGet(Name = "AddTitel")]
        public async Task<IActionResult> AddTitel()
        {
            return View();
        }

        [HttpPost(Name = "AddTitelPost")]
